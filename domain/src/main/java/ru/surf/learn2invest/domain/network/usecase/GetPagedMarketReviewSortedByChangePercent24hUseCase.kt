 ...
 * отсортированных по изменению процента за последние 24 часа.
 *
 * @param networkPagedRepository Репозиторий для получения постраничных данных с сортировкой.
 */
class GetPagedMarketReviewSortedByChangePercent24hUseCase @Inject constructor(
    ...
    override operator fun invoke(
        ...
        search = search,
        sortBy = NetworkPagedRepository.Companion.SortBy.ChangePercent24h,
        pageSize = pageSize,
        onStart = onStart,
        onEnd = onEnd
    )
